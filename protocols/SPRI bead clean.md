...
15. Return samples to magnet and incubate at room temperature until solution is clear (~5 min). 
16. Transfer samples to new tubes and discard used tubes with beads. Samples can be stored at -20 °C.
